...
define("backbone", ["underscore","jquery","json2"], (function (global) {
    return function () {
        var ret, fn;
...
define('apps/config/marionette/regions/dialog',['jquery', 'backbone', 'marionette', 'bootstrap.modal'], function ($, Backbone) {
...
define('tpl!apps/contacts/list/templates/layout.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="panel-region"></div><div id="contacts-region"></div>');}return __p.join('');}});

define('tpl!apps/contacts/list/templates/panel.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="row">    <div class="col-md-4">        <button class="btn btn-primary js-new">New contact</button>    </div>    <div class="col-md-offset-8">        <form id="filter-form" class="form-search">            <div class="input-group">                <input type="text" class="form-control search-query js-filter-criterion">                <span class="input-group-btn">                    <button type="submit" class="btn btn-default" type="button">Filter contacts</button>                    <button type="reset" class="btn btn-default" type="button">Reset</button>                </span>            </div>        </form>    </div></div>');}return __p.join('');}});

define('tpl!apps/contacts/list/templates/none.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<td colspan="3">No contacts to display.</td>');}return __p.join('');}});

define('tpl!apps/contacts/list/templates/list.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<thead><tr>    <th>First Name</th>    <th>Last Name</th>    <th></th></tr></thead><tbody></tbody>');}return __p.join('');}});

define('tpl!apps/contacts/list/templates/list_item.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<td>', firstName ,'</td><td>', lastName ,'</td><td>    <a href="#contacts/', id ,'" class="btn btn-small js-show">        <i class="icon-eye-open"></i>        Show    </a>    <a href="#contacts/', id ,'/edit" class="btn btn-small js-edit">        <i class="icon-pencil"></i>        Edit    </a>    <button class="btn btn-small js-delete">        <i class="icon-remove"></i>        Delete    </button></td>');}return __p.join('');}});

'use strict';

define('apps/contacts/list/list_view',['app',
    ...
    function (ContactManager, layoutTpl, panelTpl, noneTpl, listTpl, listItemTpl) {
        ContactManager.module('ContactsApp.List.View', function (View, ContactManager, Backbone, Marionette) {
...
define('common/views',['app', 'tpl!common/templates/loading.tpl', 'spin.jquery'], function (ContactManager, loadingTpl) {
...
define('tpl!apps/contacts/common/templates/form.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<form class="form-horizontal" role="form">    <div class="form-group">        <label for="contact-firstName" class="col-sm-3 control-label">First name:</label>        <div class="col-sm-9">            <input id="contact-firstName" class="form-control" name="firstName" type="text" value="', firstName ,'"/>        </div>    </div>    <div class="form-group">        <label for="contact-lastName" class="col-sm-3 control-label">Last name:</label>        <div class="col-sm-9">            <input id="contact-lastName" class="form-control" name="lastName" type="text" value="', lastName ,'"/>        </div>    </div>    <div class="form-group">        <label for="contact-phoneNumber" class="col-sm-3 control-label">Phone number:</label>        <div class="col-sm-9">            <input id="contact-phoneNumber" class="form-control" name="phoneNumber" type="text"                   value="', phoneNumber ,'"/>        </div>    </div>    <div class="form-group">        <div class="col-sm-offset-3 col-sm-9">            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>            <button class="btn js-submit">Save</button>        </div>    </div></form>');}return __p.join('');}});
...
define('apps/contacts/new/new_view',['app', 'apps/contacts/common/views'], function (ContactManager, CommonViews) {
    ContactManager.module('ContactsApp.New.View', function (View) {
...
define('apps/contacts/edit/edit_view',['app', 'apps/contacts/common/views'], function (ContactManager, CommonViews) {
    ContactManager.module('ContactsApp.Edit.View', function (View, ContactManager, Backbone, Marionette, $) {
        View.Contact = CommonViews.Form.extend({
            initialize: function () {
...
define('apps/contacts/list/list_controller',['app', 'apps/contacts/list/list_view'], function (ContactManager, View) {
...
define('tpl!apps/contacts/show/templates/missing.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="alert alert-error">This contact doesn\'t exist !</div>');}return __p.join('');}});

define('tpl!apps/contacts/show/templates/view.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>', firstName ,' ', lastName ,'</h1><a href="#contacts/', id ,'/edit" class="btn btn-small js-edit">    <i class="icon-pencil"></i>    Edit this contact</a><p><strong>Phone number:</strong> ', phoneNumber ,'</p>');}return __p.join('');}});

'use strict';

define('apps/contacts/show/show_view',['app',
    ...
    function (ContactManager, missingTpl, viewTpl) {
        ContactManager.module('ContactsApp.Show.View', function (View, ContactManager, Backbone, Marionette) {
...
define('apps/contacts/show/show_controller',['app', 'apps/contacts/show/show_view'], function (ContactManager, View) {
...
define('apps/contacts/edit/edit_controller',['app', 'apps/contacts/edit/edit_view'], function (ContactManager, View) {
...
define('apps/contacts/contacts_app',['backbone', 'marionette', 'app'], function (Backbone, Marionette, ContactManager) {
    ...
    ContactManager.module('Routers.ContactsApp', function (ContactsAppRouter, ContactManager) {
        ContactsAppRouter.Router = Backbone.Marionette.AppRouter.extend({
            appRoutes: {
...
define('tpl!apps/about/show/templates/message.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>About this application</h1><p>This application was designed to accompany you during your learning.</p><p>Hopefully, it has served you well !</p>');}return __p.join('');}});

'use strict';

define('apps/about/show/show_view',['backbone', 'marionette', 'tpl!apps/about/show/templates/message.tpl'], function (Backbone, Marionette, messageTpl) {
    return {
...
define('apps/about/show/show_controller',['app', 'apps/about/show/show_view'], function (ContactManager, View) {
    return {
        showAbout: function () {
...
define('apps/about/about_app',['backbone', 'marionette', 'app'], function (Backbone, Marionette, ContactManager) {
...
define('app',['backbone', 'marionette', 'apps/config/marionette/regions/dialog'], function (Backbone, Marionette, DialogRegion) {
...
define('tpl!apps/header/list/templates/list.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">    <div class="navbar-header">        <a class="navbar-brand" href="#/contacts">Contact manager</a>    </div>    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">        <ul class="nav navbar-nav"></ul>    </div></nav>');}return __p.join('');}});

define('tpl!apps/header/list/templates/list_item.tpl', function() {return function(obj) { var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#', url ,'">', name ,'</a>');}return __p.join('');}});
...
define('apps/header/list/list_view',['app',
    ...
    function (ContactManager, listTpl, listItemTpl) {
        ContactManager.module('HeaderApp.List.View', function (View, ContactManager, Backbone, Marionette) {
...
(function (root, factory) {
  if (typeof exports === 'object') {
    ...
    define('backbone.picky',['underscore', 'backbone'], factory);
...
define('entities/header',['app', 'backbone.picky'], function (ContactManager) {
    ContactManager.module('Entities', function (Entities, ContactManager, Backbone, Marionette, $, _) {
...
define('apps/header/list/list_controller',['app', 'apps/header/list/list_view'], function (ContactManager, View) {
...
define('apps/header/header_app',['app', 'apps/header/list/list_controller'], function (ContactManager, ListController) {
